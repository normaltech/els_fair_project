    ...
    return(
        <>
            <div className="changePassword_contentWrap">
                ...
                <div><Link to="#"><button className="changePassword_button changePassword_button1">확인</button></Link></div>
                <div><Link to="#"><button className="changePassword_button">취소</button></Link></div>
            </div>
            {/* <Footer /> */}
        </>
    )
